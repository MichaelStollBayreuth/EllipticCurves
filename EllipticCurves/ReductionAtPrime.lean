...
private lemma residueFieldAlgHom_residueHom {x : K} (hx : v.valuation K x ≤ 1)
  ...
  rw [residueHom_eq v ha1,
    show residueFieldAlgHom v (Ideal.Quotient.mk v.asIdeal a)
      = IsLocalRing.residue _ (algebraMap R (v.adicCompletionIntegers K) a) from
  ...
  refine lt_of_eq_of_lt ?_ ha1
  calc Valued.v ((algebraMap R (v.adicCompletionIntegers K) a
